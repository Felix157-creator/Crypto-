...
const CONFIG = {
    ...
    PAYMENT_METHODS: {
        crypto: {
            ...
            ETH: { name: 'Ethereum', symbol: 'ETH', rate: 3420, icon: 'Ξ', address ' },
            USDT: { name: 'Tether', symbol: 'USDT', rate: 1, icon: '₮', address: 'TK4rUz6TUEd7zCWeuiX5R47pSNdPswJnAc },
            BNB: { name: 'BNB', symbol: 'BNB', rate: 580, icon: 'BNB', address: 'TK4rUz6TUEd7zCWeuiX5R47pSNdPswJnAc},
            SOL: { name: 'Solana', symbol: 'SOL', rate: 145, icon: 'SOL', address: 'TK4rUz6TUEd7zCWeuiX5R47pSNdPswJnAc' }
        },
        digital: {
